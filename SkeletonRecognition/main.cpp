                ...
                {     
                    ...
                    {     
                        ...
                        {     
							...
							cout<<(int)fx<<"   "<<(int)fy<<endl;
							if(j==NUI_SKELETON_POSITION_WRIST_LEFT||j==NUI_SKELETON_POSITION_ELBOW_LEFT||j==NUI_SKELETON_POSITION_SHOULDER_LEFT||j==NUI_SKELETON_POSITION_SHOULDER_CENTER
								||j==NUI_SKELETON_POSITION_SHOULDER_RIGHT||j==NUI_SKELETON_POSITION_SPINE||j==NUI_SKELETON_POSITION_HEAD||j==NUI_SKELETON_POSITION_HIP_CENTER||
								j==NUI_SKELETON_POSITION_HIP_LEFT||j==NUI_SKELETON_POSITION_HIP_RIGHT){
								fprintf(fp,"%d ",skeletonFrame.liTimeStamp);
							}
							if(j==NUI_SKELETON_POSITION_WRIST_LEFT){
								fprintf(fp,"WRIST ");
								fprintf(fp,"%d ",skeletonPoint[i][j].x);
								fprintf(fp,"%d ",skeletonPoint[i][j].y);
								fprintf(fp,"%f ",skeletonFrame.SkeletonData[i].SkeletonPositions[j].x);
								fprintf(fp,"%f ",skeletonFrame.SkeletonData[i].SkeletonPositions[j].y);
								fprintf(fp,"%f\n",skeletonFrame.SkeletonData[i].SkeletonPositions[j].z);
							}
							if(j==NUI_SKELETON_POSITION_ELBOW_LEFT){
								fprintf(fp,"ELBOW ");
								fprintf(fp,"%d ",skeletonPoint[i][j].x);
								fprintf(fp,"%d ",skeletonPoint[i][j].y);
								fprintf(fp,"%f ",skeletonFrame.SkeletonData[i].SkeletonPositions[j].x);
							...
							if(j==NUI_SKELETON_POSITION_SHOULDER_LEFT){
								fprintf(fp,"SHOULDER ");
								fprintf(fp,"%d ",skeletonPoint[i][j].x);
								fprintf(fp,"%d ",skeletonPoint[i][j].y);
								fprintf(fp,"%f ",skeletonFrame.SkeletonData[i].SkeletonPositions[j].x);
							...
							if(j==NUI_SKELETON_POSITION_SHOULDER_RIGHT){
								fprintf(fp,"SHOULDER_RIGHT ");
								fprintf(fp,"%d ",skeletonPoint[i][j].x);
								fprintf(fp,"%d ",skeletonPoint[i][j].y);
								fprintf(fp,"%f ",skeletonFrame.SkeletonData[i].SkeletonPositions[j].x);
								fprintf(fp,"%f ",skeletonFrame.SkeletonData[i].SkeletonPositions[j].y);
							...
							if(j==NUI_SKELETON_POSITION_SPINE){
								fprintf(fp,"SPINE ");
								fprintf(fp,"%d ",skeletonPoint[i][j].x);
								fprintf(fp,"%d ",skeletonPoint[i][j].y);
								fprintf(fp,"%f ",skeletonFrame.SkeletonData[i].SkeletonPositions[j].x);
							...
							if(j==NUI_SKELETON_POSITION_HIP_CENTER){
								fprintf(fp,"HIP_CENTER ");
								fprintf(fp,"%d ",skeletonPoint[i][j].x);
								fprintf(fp,"%d ",skeletonPoint[i][j].y);
								fprintf(fp,"%f ",skeletonFrame.SkeletonData[i].SkeletonPositions[j].x);
								fprintf(fp,"%f ",skeletonFrame.SkeletonData[i].SkeletonPositions[j].y);
							...
							if(j==NUI_SKELETON_POSITION_HIP_LEFT){
								fprintf(fp,"HIP_LEFT ");
								fprintf(fp,"%d ",skeletonPoint[i][j].x);
								fprintf(fp,"%d ",skeletonPoint[i][j].y);
								fprintf(fp,"%f ",skeletonFrame.SkeletonData[i].SkeletonPositions[j].x);
							...
							if(j==NUI_SKELETON_POSITION_HIP_RIGHT){
								fprintf(fp,"HIP_RIGHT ");
								fprintf(fp,"%d ",skeletonPoint[i][j].x);
								fprintf(fp,"%d ",skeletonPoint[i][j].y);
								fprintf(fp,"%f ",skeletonFrame.SkeletonData[i].SkeletonPositions[j].x);
								fprintf(fp,"%f ",skeletonFrame.SkeletonData[i].SkeletonPositions[j].y);
